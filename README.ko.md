...
그 답답함 때문에 **Panel 040**을 만들었습니다. 템플릿을 덮는 대신 사진에서 절대 잃으면 안 될 것을 먼저 찾고, **사진이 정말 말하고 있는 것을 하나의 실제 앵커와 작은 검은 선 이야기로 바꿉니다**로 번역합니다.
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 040 예시 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 040 예시 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 040 예시 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 040 예시 8"></td>
  </tr>
</table>
