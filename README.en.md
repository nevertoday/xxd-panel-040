...
That frustration is why I made **Panel 040**. It does not press a template onto your image. It first works out what must not be lost, then translates it into **Turn what a photograph is truly saying into one real anchor and a tiny black-line story**.
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 040 Sample 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 040 Sample 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 040 Sample 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 040 Sample 8"></td>
  </tr>
</table>
